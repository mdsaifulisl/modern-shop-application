    ...
    <div className="dashboard-main-head py-3 px-4 d-flex justify-content-between align-items-center bg-white border-bottom">
      ...
      <div className="view">
        ...
        <div className="d-flex flex-wrap align-items-baseline gap-2">
          <h4 className="text-success fw-bold mb-0">$ {totalRevenue.toFixed(2)}</h4>
      ...
      <div className="notifications d-flex align-items-center gap-2 gap-md-4">
        ...
        {/* Messages */}
        <div className="position-relative p-2 pointer hover-bg-light rounded shadow-sm" style={{ cursor: "pointer" }} onClick={handleMessageClick}>
